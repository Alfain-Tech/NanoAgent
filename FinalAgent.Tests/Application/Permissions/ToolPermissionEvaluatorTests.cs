...
namespace FinalAgent.Tests.Application.Permissions;
...
public sealed class ToolPermissionEvaluatorTests : IDisposable
{
    ...
    public ToolPermissionEvaluatorTests()
    {
        _workspaceRoot = Path.Combine(
            Path.GetTempPath(),
            $"FinalAgent-Permissions-{Guid.NewGuid():N}");
    ...
    private sealed class StubWorkspaceRootProvider : global::FinalAgent.Application.Abstractions.IWorkspaceRootProvider
    {
        private readonly string _workspaceRoot;
